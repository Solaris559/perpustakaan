                                                        ...
                                                        <form action="<?= base_url('home/tambah_buku') ?>" method="post"
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="jumlah_buku" class="form-label">Jumlah
                                                                    Buku</label>
                                                                <input type="number" class="form-control"
                                                                    id="jumlah_buku" name="jumlah_buku" required>
                                                            </div>
                                                            <div class="mb-3">
                                            ...
                                            <table id="example" class="table table-striped table-bordered align-middle">
                                                ...
                                                <tbody>
                                                    <?php foreach ($buku as $index => $data): ?>
                                                        ...
                                                        <div class="modal fade" id="edit<?= $data['id_buku'] ?>"
                                                            tabindex="-1" aria-labelledby="editLabel<?= $data['id_buku'] ?>"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-dialog-scrollable">
                                                                <div class="modal-content">
                                                                    <div class="modal-header bg-success text-white">
                                                        ...
                                                        <!-- Modal Hapus buku -->
                                                        <div class="modal fade" id="hapus<?= $data['id_buku'] ?>"
                                                            tabindex="-1"
                                                                ...
                                                                <div class="modal-content">
                                                                    <div class="modal-header bg-success text-white">
                                                                        <h1 class="modal-title fs-5"
                                                                            ...
                                                                            <i
                                                                                class="bi bi-person-badge-fill me-2"></i>Hapus
                                                                            Data Buku
                                                                        </h1>
                                                                        <button type="button" class="btn-close"
                                                                            data-bs-dismiss="modal"
